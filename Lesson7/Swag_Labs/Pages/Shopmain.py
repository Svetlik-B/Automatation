...
class ShopmainPage:
    ...
    def buy_issue(self):
        self.Sauce_Labs_Backpack = (By.NAME, "add-to-cart-sauce-labs-backpack")
        self.Sauce_Labs_Bolt_TShirt = (By.NAME, "add-to-cart-sauce-labs-bolt-t-shirt")
        self.Sauce_Labs_Onesie = (By.NAME, "add-to-cart-sauce-labs-onesie")
