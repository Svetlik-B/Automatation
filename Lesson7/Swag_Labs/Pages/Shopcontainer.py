...
class ShopContainer:
    ...
    def info(self):
        ...
        self.browser.find_element(*self.first_name).send_keys("Olga")
        self.last_name = (By.ID, "last-name")
        self.browser.find_element(*self.last_name).send_keys("Ivanova")
        self.postcode = (By.ID, "postal-code")
        self.browser.find_element(*self.postcode).send_keys("341234")
